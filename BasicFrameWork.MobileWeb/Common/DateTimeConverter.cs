...
namespace BasicFramework.MobileWeb.Common
{
 ...
 : JavaScriptConverter
    ...
    object>
     dictionary, Type type, JavaScriptSerializer serializer)
        {
            return new JavaScriptSerializer().ConvertToType(dictionary,
     type);
        }
 ...
 { typeof(DateTime)
    ...
    object>>.Add(KeyValuePair<string,
    object>
     item)
            {
                throw new NotImplementedException();
    ...
    object>>.Contains(KeyValuePair<string,
    object>
     item)
            {
                throw new NotImplementedException();
            ...
            void ICollection<KeyValuePair<string,
    object>>.CopyTo(KeyValuePair<string,
    object>[]
     array, int arrayIndex)
            ...
            int ICollection<KeyValuePair<string,
    object>>.Count
            {
                get
                {
    ...
    object>>.IsReadOnly
            ...
            bool ICollection<KeyValuePair<string,
    object>>.Remove(KeyValuePair<string,
    object>
     item)
            {
                throw new NotImplementedException();
