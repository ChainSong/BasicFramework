...
using BasicFramework.Web.Models;
...
namespace System.Web.Mvc
{
    public static class HtmlHelperExtension
    {
        ...
        {
            return Pager(helper, pageIndex, pageCount, 0, identify);
        }

        public static MvcHtmlString Pager(this HtmlHelper helper, int pageIndex, int pageCount,int totalCount, string identify)
        {
            PagerViewModel model = new PagerViewModel() { PageIndex = pageIndex, PageCount = pageCount, Identify = identify, TotalCount = totalCount };
